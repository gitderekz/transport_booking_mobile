        ...
        child: BottomAppBar(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(context, 1, Icons.search, localizer.translate('search')!),
              const SizedBox(width: 40),
              _buildNavItem(context, 2, Icons.confirmation_num_outlined, localizer.translate('tickets')!),
              _buildNavItem(context, 3, Icons.person_outlined, localizer.translate('profile')!),
            ],
          ),
        ),
      ),
